// assets/js/components/ScanDetail.js
        ...
        <div class="section result-section">
            <div class="container">
                ...
                <div class="results-header fade-in">
                    <div>
                        <h1 class="section-title">Scan Detail</h1>
                        <p class="section-subtitle">Historical report from <span id="report-date">August 1, 2026</span></p>
                    </div>
                    <div class="action-buttons">
                        <a href="/history" data-link class="btn btn-outline"><i class="fa-solid fa-arrow-left"></i> Back to History</a>
...
export function initScanDetail(router) {
